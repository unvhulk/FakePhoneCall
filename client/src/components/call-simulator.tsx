...
export default function CallSimulator() {
  ...
  const startCall = () => {
    ...
    // Set random avatar
    const randomAvatar = contactAvatars[Math.floor(Math.random() * contactAvatars.length)];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-ios-light-gray via-white to-ios-light-gray flex flex-col">
        ...
        <header className="text-center py-8 px-6">
          ...
          <p className="ios-gray text-sm">The perfect excuse - realistic iPhone call simulator</p>
        </header>
        ...
        <div className="flex-1 flex flex-col justify-center px-6 max-w-md mx-auto w-full">
          ...
          <Card className="mb-6">
            <CardContent className="p-6">
              <h2 className="text-xl font-semibold mb-4 text-center">Create Your Fake Call</h2>
              
              {/* Contact Name Input */}
              <div className="mb-4">
                <Label className="text-sm font-medium ios-gray mb-2">Contact Name</Label>
                <Input
                  type="text"
              ...
              {/* Preset Contacts */}
              <div className="mb-6">
                <Label className="text-sm font-medium ios-gray mb-3">Quick Presets</Label>
        ...
        <footer className="text-center py-6 px-6">
          <p className="text-xs ios-gray">Free forever • No app required • Works on any device</p>
        </footer>
      </div>
    );
  }
    ...
    return (
      <div className="fixed inset-0 bg-ios-call-bg text-white z-50 slide-up active">
        ...
        <div className="text-center px-6 mt-16 mb-12">
          ...
          {/* Call Duration */}
          <p className="text-lg text-gray-300 call-timer">{formatTime(callDuration)}</p>
        </div>
